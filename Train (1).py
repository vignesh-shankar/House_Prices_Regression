...
clf = DecisionTreeRegressor(criterion='mse', splitter='best', max_depth=40, min_samples_split=2, min_samples_leaf=30, min_weight_fraction_leaf=0.0, max_features=None, random_state=1234, max_leaf_nodes=None, min_impurity_split=1e-07, presort=False)
clf = clf.fit(X_train,Y_train)


# In[123]:

filename = 'C:\Users\Vignesh\Documents\\dtmodel_withoutreduction.sav'
